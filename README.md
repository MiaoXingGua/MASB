...
### 基础操作
- 🎮 **启动游戏**
- 🎁 **接受贡礼**：领取所有免费的贡礼（后续考虑加入自选的付费领取功能）
- 📩 **收取信息**：读取所有新信息

### 古堡系统
- 🌍 **八方游历**：执行八方游历
- 🏛️ **议事阁**：自动开会（后续考虑加入好感度满自动换人功能）

### 商店系统
- 🏪 **人偶商店**：杂货铺，购买免费物品
- 🧛 **鲜血商店**：鲜血商店购买所有晶球（后续考虑加入可选制定晶球）

### 社交系统
- 👫 **好友-一键收赠**：自动收礼
- 🔄 **好友-清理好友**：自动清理不活跃好友（后续考虑加入清理指定天数不上线的好友）
- 📥 **好友-申请好友**：自动通过/申请好友

### 忘却中庭
- ⚔️ **英灵剑冢**：自动扫荡英灵剑冢（目前挑战的是无常亡魂，需要提前手动打好，这里只去扫荡）
- ⏳ **时计塔楼**：自动扫荡计塔楼（同上，需要自己打好，这里负责只扫荡）
- 🌌 **通天深渊**：自动挑战通天深渊（目前只打种族塔，没打通用塔）
- 🎭 **斗技场_竞演赛**：参与斗技场竞演赛（目前只挑战斗力<14w的，后续考虑做成可选数值）
- 🔥 **斗技场_死斗赛**：参与斗技场死斗赛（目前只挑战斗力<45w的，后续考虑做成可选数值）
...
详细操作说明请参考 [用户手册](docs/zh_cn/usage.md)（持续更新中）

## 环境依赖与常见问题

### 环境准备
- 运行前请确保已安装 Python 3.8+ 环境
- 核心依赖安装：若启动时出现 `ModuleNotFoundError: No module named 'maa'`，请打开命令行执行以下命令安装依赖：
python -m pip install maafw

### 常见问题
- 若遇到功能异常，请先检查游戏版本是否匹配
- 自动化操作可能受分辨率、游戏设置影响，建议使用默认游戏配置
- 邀约/八方游历等功能无奖励时会直接结束，避免因识别问题卡顿
- 英灵剑冢/时计塔楼等功能已增加“今日已执行”检测，避免重复操作
- 更多问题请查看 [FAQ](docs/zh_cn/faq.md) 或提交 [Issue](https://github.com/MiaoXingGua/MASB/issues)

## 加入我们
🐧 交流群：[1063600627](http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=1063600627)

欢迎反馈问题、提出建议或参与开发，一起完善工具功能！

## 免责声明
本软件为开源免费工具，仅供学习交流使用。请勿用于商业用途或违反游戏规则的行为。

使用过程中因软件漏洞、操作失误等导致的任何问题，开发组不承担责任，请谨慎使用。

## 鸣谢
- 核心框架：[MaaXYZ/MaaFramework](https://github.com/MaaXYZ/MaaFramework)
- GUI 组件：[SweetSmellFox/MFAAvalonia](https://github.com/SweetSmellFox/MFAAvalonia)
- 测试工具：[MaaXYZ/MaaDebugger](https://github.com/MaaXYZ/MaaDebugger)
